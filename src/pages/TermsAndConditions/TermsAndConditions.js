 ...
 * 
 * and:
 * https://www.nibusinessinfo.co.uk/content/sample-website-disclaimer
 */
export default function TermsAndConditions() {
  return (
    <>
      <Helmet><title>Oboe - Terms</title></Helmet>
      <Container>
        <Typography variant="h1" id="main-content">Terms and Conditions</Typography>
